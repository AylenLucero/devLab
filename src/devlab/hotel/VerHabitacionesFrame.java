...
public class VerHabitacionesFrame extends javax.swing.JFrame {
    ...
    private javax.swing.JPanel crearCardHabitacion(Map<String, Object> hab) {
        ...
        content.add(new JLabel("Capacidad: " + hab.get("personas")));
        content.add(new JLabel("Precio por noche: $" + hab.get("precio")));
        content.add(new JLabel("Disponibilidad: " + hab.get("disponibilidad")));
        content.add(new JLabel("Camas dobles: " + hab.get("dobles")));
        content.add(new JLabel("Camas simples: " + hab.get("simples")));
