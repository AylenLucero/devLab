...
public class AdminReservas {
   ...
   public void EditarReserva() {
        ...
        try {
            ...
            // Verificar superposicion con otras reservas
            boolean ocupado = conn.ExisteSuperposicionReservaExcluyendo(idHabitacion, fechaInicio, fechaFin, idReserva);
            if (ocupado) {
                System.out.println("La habitacion ya esta reservada en ese rango de fechas. No se puede editar la reserva.");
                return;
            }
