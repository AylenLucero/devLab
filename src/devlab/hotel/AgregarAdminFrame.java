 ...
 * @author Rodrigo
 */
public class AgregarAdminFrame extends javax.swing.JFrame {
    DBConnection conn = new DBConnection();
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AgregarAdminFrame.class.getName());

    /**
     * Creates new form AgregarAdminFrame
     */
    public AgregarAdminFrame() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(midni > 0){
            conn.actualizarTipoAAdministrador(midni);
        }else{
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new AgregarAdminFrame().setVisible(true));
    }
